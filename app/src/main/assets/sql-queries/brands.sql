...
INSERT INTO companies (company_name, discrete_title) VALUES ('ΚΟΥΚΛΗΣ Δ ΚΑΙ Σ ΟΕ', 'Ταβέρνα Κούκλης', 'Εστίαση');
...
INSERT INTO companies (company_name, discrete_title) VALUES ('ΑΦΟΙ ΚΑΛΛΙΑΡΙΔΗ ΟΕ', 'ΕΚΟ', 'Καύσιμα');
...
INSERT INTO companies (company_name, discrete_title) VALUES ('ΦΑΡΜΑΚΕΙΟ ΧΡΗΣΤΟΥ ΠΟΝΤΙΚΗ ΚΑΙ', 'Drug-store.gr', 'Ιατροφαρμακευτικά');
INSERT INTO companies (company_name, discrete_title) VALUES ('ΠΑΥΛΙΔΗΣ TILES ΜΟΝΟΠΡΟΣΩΠΗ ΙΔΙ', 'Παυλίδης', 'Οικιακά Είδη');
